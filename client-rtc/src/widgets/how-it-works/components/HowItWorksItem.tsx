...
export const HowItWorksItem = ({
    ...
    return (
        ...
        >
            <div className="relative w-14 h-14 rounded-full bg-surface-accent flex items-center justify-center shadow-sm transition-all duration-300 group-hover:-translate-y-1 group-hover:shadow-lg">
